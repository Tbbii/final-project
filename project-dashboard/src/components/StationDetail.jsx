  ...
  if (!station) return (
    <div style={{ textAlign: 'center', marginTop: 40 }}>
      ...
      <p style={{ fontSize: 14, color: '#9ca3af' }}>
        กดที่จุดบนแผนที่<br/>เพื่อดูรายละเอียดสถานี
      </p>
    </div>
  )
  ...
  return (
    <div>
      ...
      <div style={{
        ...
        <p style={{ fontSize: 13, color: '#fff', margin: '4px 0 0', opacity: 0.9 }}>
      ...
      <div style={{
        ...
        <p style={{ fontSize: 12, color: '#6b7280', margin: '0 0 2px' }}>PM2.5</p>
