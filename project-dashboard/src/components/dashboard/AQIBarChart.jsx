export default function AQIBarChart({ stats }) {
  ...
  const noData =
    total - stats.good - stats.moderate - stats.unhealthy - stats.hazardous;
  ...
  const bars = [
    ...
    { label: "มีผลต่อสุขภาพ", count: stats.hazardous, color: "#ef4444" },
    { label: "ไม่มีข้อมูล", count: noData, color: "#d1d5db" },
  ].filter((b) => b.count > 0);
